...
*   **AIファイル解析**: PDFファイル (`.pdf`)の読み込み時に、Gemini AIによる高度なファイル解析を利用できます（オプション設定で有効化）。複雑なレイアウトや複数カラムの文書も、AIが文書構造を理解して正確にテキストを抽出します。進捗は4段階（準備中→ファイル読み込み中→AI解析中→最終処理中）で表示され、処理状況を把握できます。
